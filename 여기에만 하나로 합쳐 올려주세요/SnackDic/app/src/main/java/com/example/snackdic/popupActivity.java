...
//                cur_lon = loc_cur.getLongitude(); // 경도
        ...
        near = (LinearLayout) findViewById(R.id.near_Button);
        appconnect = (LinearLayout) findViewById(R.id.app_Button);
        ...
        appconnect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
